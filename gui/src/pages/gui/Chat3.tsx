          ...
          {history.length === 0 && (
            <div className="flex flex-col items-center justify-center mt-16 mb-8">
              ...
              <div className="flex flex-col gap-4 w-full max-w-3xl mx-auto px-4">
                <div className="relative bg-gradient-to-br from-black/30 to-black/10 backdrop-blur-md rounded-xl p-6 border border-[#FFD700]/10 group hover:border-[#FFD700]/30 transition-all duration-500 overflow-hidden">
                  ...
                  <div className="relative">
                    <div className="font-medium mb-4 text-base flex items-center gap-2 text-[#FFD700]">
                      ...
                      <span className="group-hover:text-[#FFA500] transition-colors duration-300">Core Features</span>
                    </div>
                ...
                <div className="relative bg-gradient-to-br from-black/30 to-black/10 backdrop-blur-md rounded-xl p-6 border border-[#FFD700]/10 group hover:border-[#FFD700]/30 transition-all duration-500 overflow-hidden mb-8">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  
                  <div className="relative">
                    <div className="font-medium mb-4 text-base flex items-center gap-2 text-[#FFD700]">
                      <BoltIcon className="h-5 w-5 animate-pulse" />
                      <span className="group-hover:text-[#FFA500] transition-colors duration-300">Core Advantages</span>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex items-start gap-2 group/item hover:bg-[#FFD700]/5 p-2 rounded-lg transition-all duration-300">
